...
# THIS SCRIPT IS FOR PROVISIONING COLD CLUSTER VMs WHEN THE UNDERLYING ATTACHED SSD DISKS ALREADY EXIST WITH THE RELEVANT KYOTO FILES
...
then
     ...
     elif [[ $3 -eq 2 ]] || [[ $3 -eq 4 ]] || [[ $3 -eq 5 ]] || [[ $3 -eq 7 ]] || [[ $3 -eq 8 ]] || [[ $3 -eq 9 ]] || [[ $3 -eq 11 ]] || [[ $3 -eq 15 ]] || [[ $3 -eq 12 ]] || [[ $3 -eq 22 ]] || [[ $3 -eq 24 ]] || [[ $3 -eq 29 ]] || [[ $3 -eq 30 ]] 
     then
...
attach_backend() {
  if [[ $3 -eq 2 ]] || [[ $3 -eq 4 ]] || [[ $3 -eq 5 ]] || [[ $3 -eq 7 ]] || [[ $3 -eq 8 ]] || [[ $3 -eq 9 ]] || [[ $3 -eq 11 ]] || [[ $3 -eq 15 ]] || [[ $3 -eq 12 ]] || [[ $3 -eq 22 ]] || [[ $3 -eq 24 ]] || [[ $3 -eq 29 ]] || [[ $3 -eq 30 ]] || [[ $3 -eq 39 ]] || [[ $3 -eq 40 ]] || [[ $3 -eq 41 ]] || [[ $3 -eq 43 ]] || [[ $3 -eq 44 ]] || [[ $3 -eq 51 ]] || [[ $3 -eq 52 ]] || [[ $3 -eq 53 ]] || [[ $3 -eq 56 ]] || [[ $3 -eq 63 ]] || [[ $3 -eq 65 ]] || [[ $3 -eq 66 ]] || [[ $3 -eq 67 ]] || [[ $3 -eq 69 ]] || [[ $3 -eq 72 ]] || [[ $3 -eq 75 ]] || [[ $3 -eq 78 ]] || [[ $3 -eq 80 ]] || [[ $3 -eq 81 ]] || [[ $3 -eq 82 ]] || [[ $3 -eq 86 ]] || [[ $3 -eq 89 ]] || [[ $3 -eq 94 ]] || [[ $3 -eq 96 ]] || [[ $3 -eq 102 ]] 
  then
    gcloud compute backend-services add-backend $1 --instance-group=$2 --instance-group-zone=asia-south1-a --global
    gcloud compute instance-groups managed set-named-ports $2 --named-ports "http:80" --zone=asia-south1-a
  ...
  then
    ...
    gcloud compute instance-groups managed set-named-ports $2 --named-ports "http:80" --zone=asia-south1-b
  ...
  then
    ...
    gcloud compute instance-groups managed set-named-ports $2 --named-ports "http:80" --zone=asia-south1-c
  fi
}
